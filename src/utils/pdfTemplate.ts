...
function buildFooterHTML(settings?: PdfSettings): string {
...
export function buildPdfHtml(
  ...
  const headerHTML = hasHeader ? buildHeaderHTML(pdfSettings) : "";
  const footerHTML = hasFooter ? buildFooterHTML(pdfSettings) : "";
